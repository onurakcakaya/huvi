                ...
                <div class="space-y-4">
                  <div>
                    ...
                    <textarea 
                      ...
                      rows="3" 
                      placeholder="İşletmeniz hakkında kısa bir bilgi..." 
                      class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500">
                    </textarea>
                  </div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input 
                        id="instagram" 
                        name="instagram" 
                        v-model="business.instagram_url" 
                        type="url" 
