      ...
      <div class="flex justify-between h-16">
        ...
        <div class="flex items-center flex-shrink-0 gap-2 sm:gap-4">
          ...
          <RouterLink to="/" class="flex items-center gap-2 group">
            ...
            <!-- Eski vite.svg yerine senin yeni yüklediğin logonun adını yazdık -->
            <img src="/android-chrome-192x192.png" alt="Logo" class="h-8 w-8 rounded-lg object-cover transition transform group-hover:scale-110" /> 
        ...
        <div class="flex items-center space-x-2 sm:space-x-3">
          ...
          <div v-else class="relative ml-1 sm:ml-2">
            ...
            <div v-if="isMenuOpen" class="absolute right-0 mt-3 w-56 bg-white rounded-xl shadow-xl py-2 border border-gray-100 z-50 ring-1 ring-black ring-opacity-5">
              ...
              <RouterLink to="/profile/:id" class="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-700 transition">
